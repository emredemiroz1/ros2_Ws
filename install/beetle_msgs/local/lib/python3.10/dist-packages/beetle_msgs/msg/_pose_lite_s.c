...
bool beetle_msgs__msg__pose_lite__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("beetle_msgs.msg._pose_lite.PoseLite", full_classname_dest, 35) == 0);
  }
  beetle_msgs__msg__PoseLite * ros_message = _ros_message;
  {  // x
...
{
  /* NOTE(esteve): Call constructor of PoseLite */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("beetle_msgs.msg._pose_lite");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PoseLite");
