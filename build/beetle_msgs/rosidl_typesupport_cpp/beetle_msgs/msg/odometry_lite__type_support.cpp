...
static const _OdometryLite_type_support_symbol_names_t _OdometryLite_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, beetle_msgs, msg, OdometryLite)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, beetle_msgs, msg, OdometryLite)),
  }
};
...
{
  return &::beetle_msgs::msg::rosidl_typesupport_cpp::OdometryLite_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, beetle_msgs, msg, OdometryLite)() {
  return get_message_type_support_handle<beetle_msgs::msg::OdometryLite>();
}
