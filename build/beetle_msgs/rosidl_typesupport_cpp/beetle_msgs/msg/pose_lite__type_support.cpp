...
static const _PoseLite_type_support_symbol_names_t _PoseLite_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, beetle_msgs, msg, PoseLite)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, beetle_msgs, msg, PoseLite)),
  }
};
...
{
  return &::beetle_msgs::msg::rosidl_typesupport_cpp::PoseLite_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, beetle_msgs, msg, PoseLite)() {
  return get_message_type_support_handle<beetle_msgs::msg::PoseLite>();
}
