...
#include "beetle_msgs/msg/detail/twist_lite__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = beetle_msgs::msg::TwistLite;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const beetle_msgs::msg::TwistLite *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<beetle_msgs::msg::TwistLite *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TwistLite__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const beetle_msgs::msg::TwistLite *>(
...
static size_t _TwistLite__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_TwistLite(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _TwistLite__callbacks = {
  "beetle_msgs::msg",
  "TwistLite",
...
static rosidl_message_type_support_t _TwistLite__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TwistLite__callbacks,
...
{
  return &beetle_msgs::msg::typesupport_fastrtps_cpp::_TwistLite__handle;
}
