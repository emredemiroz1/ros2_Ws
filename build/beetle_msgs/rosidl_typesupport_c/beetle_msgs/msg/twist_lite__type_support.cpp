...
static const _TwistLite_type_support_symbol_names_t _TwistLite_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, beetle_msgs, msg, TwistLite)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, beetle_msgs, msg, TwistLite)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, beetle_msgs, msg, TwistLite)() {
  return &::beetle_msgs::msg::rosidl_typesupport_c::TwistLite_message_type_support_handle;
}
